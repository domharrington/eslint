    ...
    describe("applyFixes()", function() {
        ...
        describe("Text Insertion", function() {
            ...
            it("should insert text at the end of the code", function() {
                var result = TextFixer.applyFixes(TEST_CODE, [ INSERT_AT_END ]);
            ...
            it("should insert text at the beginning, middle, and end of the code", function() {
                var result = TextFixer.applyFixes(TEST_CODE, [ INSERT_IN_MIDDLE, INSERT_AT_START, INSERT_AT_END ]);
        ...
        describe("Text Replacement", function() {
            ...
            it("should replace text at the end of the code", function() {
                var result = TextFixer.applyFixes(TEST_CODE, [ REPLACE_VAR ]);
                assert.equal(result.messages.length, 0);
            ...
            it("should replace text at the beginning of the code", function() {
                var result = TextFixer.applyFixes(TEST_CODE, [ REPLACE_ID ]);
                assert.equal(result.messages.length, 0);
            ...
            it("should replace text in the middle of the code", function() {
                var result = TextFixer.applyFixes(TEST_CODE, [ REPLACE_NUM ]);
                assert.equal(result.messages.length, 0);
            ...
            it("should replace text at the beginning and end of the code", function() {
                var result = TextFixer.applyFixes(TEST_CODE, [ REPLACE_ID, REPLACE_VAR, REPLACE_NUM ]);
                assert.equal(result.messages.length, 0);
        ...
        describe("Text Removal", function() {
            ...
            it("should remove text at the start of the code", function() {
                var result = TextFixer.applyFixes(TEST_CODE, [ REMOVE_START ]);
                assert.equal(result.messages.length, 0);
            ...
            it("should remove text in the middle of the code", function() {
                var result = TextFixer.applyFixes(TEST_CODE, [ REMOVE_MIDDLE ]);
                assert.equal(result.messages.length, 0);
            ...
            it("should remove text towards the end of the code", function() {
                var result = TextFixer.applyFixes(TEST_CODE, [ REMOVE_END ]);
                assert.equal(result.messages.length, 0);
            ...
            it("should remove text at the beginning, middle, and end of the code", function() {
                var result = TextFixer.applyFixes(TEST_CODE, [ REMOVE_END, REMOVE_START, REMOVE_MIDDLE ]);
                assert.equal(result.messages.length, 0);
        ...
        describe("Combination", function() {
            ...
            it("should replace text at the beginning, remove text in the middle, and insert text at the end", function() {
                var result = TextFixer.applyFixes(TEST_CODE, [ INSERT_AT_END, REMOVE_END, REPLACE_VAR ]);
            ...
            it("should only apply one fix when ranges overlap", function() {
                var result = TextFixer.applyFixes(TEST_CODE, [ REMOVE_MIDDLE, REPLACE_ID ]);
                assert.equal(result.output, TEST_CODE.replace("answer", "a"));
            ...
            it("should apply two fixes when the end of one range is the same as the start of a previous range overlap", function() {
                var result = TextFixer.applyFixes(TEST_CODE, [ REMOVE_START, REPLACE_ID ]);
            ...
            it("should only apply one fix when ranges overlap and one message has no fix", function() {
                var result = TextFixer.applyFixes(TEST_CODE, [ REMOVE_MIDDLE, REPLACE_ID, NO_FIX ]);
                assert.equal(result.output, TEST_CODE.replace("answer", "a"));
        ...
        describe("No Fixes", function() {
            ...
            it("should only apply one fix when ranges overlap and one message has no fix", function() {
                var result = TextFixer.applyFixes(TEST_CODE, [ NO_FIX ]);
