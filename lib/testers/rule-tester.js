...
var assert = require("assert"),
    ...
    TextFixer = require("../util/text-fixer");
        ...
        function testInvalidTemplate(ruleName, item) {
            ...
            if (typeof item.errors === "number") {
                ...
                if (item.hasOwnProperty("output")) {
                    var result = (new TextFixer()).applyFixes(item.code, messages);
                    assert.equal(result.output, item.output, "Fixes should have been applied.");
                }
